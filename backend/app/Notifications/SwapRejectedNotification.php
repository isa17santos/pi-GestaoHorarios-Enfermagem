...
class SwapRejectedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->greeting('Ola,')
            ->line('Uma troca de turno foi rejeitada.')
    ...
    public function toCustomDatabase(object $notifiable): array
    {
        ...
        return [
            'subject' => 'Troca de Turno Rejeitada',
            'body' => "Troca rejeitada entre {$requesterName} e {$targetName}. Turno oferecido: {$offeredDate} ({$offeredType}). Turno solicitado: {$requestedDate} ({$requestedType}).",
        ];
    }
}
