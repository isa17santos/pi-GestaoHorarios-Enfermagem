...
return [
    ...
    'current_password_incorrect' => 'The password you entered does not match your current password.',
    'new_password_must_be_different' => 'The new password cannot be the same as your current password.',
